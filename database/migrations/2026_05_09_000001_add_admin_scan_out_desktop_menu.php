...
return new class extends Migration {
    public function up(): void
    {
        ...
        DB::table('menus')->updateOrInsert(
            ['slug' => 'outbound-scan-out'],
            [
                'name' => 'Scan Out Desktop',
                'route' => 'admin.outbound.scan-out.index',
        ...
        $menuId = DB::table('menus')->where('slug', 'outbound-scan-out')->value('id');
    ...
    public function down(): void
    {
        ...
        DB::table('menus')->where('slug', 'outbound-scan-out')->delete();
    }
};
