...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('menus')->updateOrInsert(
            ['slug' => 'attendance-live-display'],
            [
                'name' => 'Live Display',
                'route' => 'admin.attendance.live-display.index',
                'icon' => 'fas fa-tv',
        ...
        $menuId = DB::table('menus')->where('slug', 'attendance-live-display')->value('id');
    ...
    public function down(): void
    {
        ...
        DB::table('menus')->where('slug', 'attendance-live-display')->delete();
    }
};
