...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        $menuRows = [
            ...
            ['name' => 'Attendance', 'slug' => 'attendance', 'route' => null, 'icon' => 'fas fa-fingerprint', 'parent_slug' => null, 'sort_order' => 16],
            ...
            ['name' => 'Monitor Lembur', 'slug' => 'attendance-overtime', 'route' => 'admin.attendance.overtime.index', 'icon' => 'fas fa-business-time', 'parent_slug' => 'attendance', 'sort_order' => 10.3],
