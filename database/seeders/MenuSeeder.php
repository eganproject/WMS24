...
class MenuSeeder extends Seeder
{
    public function run(): void
    {
        $menuRows = [
            ...
            ['name' => 'Riwayat Packing', 'slug' => 'outbound-packer-history', 'route' => 'admin.outbound.packer-history.index', 'icon' => 'fa-solid fa-box-archive', 'parent_slug' => 'outbound', 'sort_order' => 13.5],
            ['name' => 'Riwayat Scan Out', 'slug' => 'outbound-packer-scan-outs', 'route' => 'admin.outbound.packer-scan-outs.index', 'icon' => 'fa-solid fa-truck-ramp-box', 'parent_slug' => 'outbound', 'sort_order' => 13.7],
            ...
            ['name' => 'Laporan Packing', 'slug' => 'outbound-packer-packing-report', 'route' => 'admin.reports.packer-packing-reports.index', 'icon' => 'fa-solid fa-box-archive', 'parent_slug' => 'reports', 'sort_order' => 1.15],
