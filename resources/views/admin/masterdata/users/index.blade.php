...
@push('toolbar')
    @include('layouts.partials._toolbar', [
        'title' => 'Users',
        'breadcrumbs' => ['Admin', 'Masterdata', 'Users'],
    ])
@endpush
            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" id="user_search_input" class="form-control form-control-solid w-250px ps-15"
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="{{ route('admin.masterdata.users.create') }}" class="btn btn-primary">Tambah Users</a>
                    </div>
                    @endif
                    <!--end::Toolbar-->
                </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="table-on-page">
                            <thead>
                                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px sorting">Jabatan</th>
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>{{ $user->warehouse->name ?? 'Semua / Tidak terikat' }}</td>
                                        ...
                                        <td>
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <a href="{{ route('admin.masterdata.users.edit', $user->id) }}"
                                                ...
                                                <div class="menu-item px-3">
                                                    <form class="form-delete"
                                                        action="{{ route('admin.masterdata.users.destroy', $user->id) }}" method="POST"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#table-on-page').on('submit', '.form-delete', function(e) {
                ...
                var form = $(this);
                var n = form.find('button[data-user-name]').data('user-name');
