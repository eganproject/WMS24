...
@push('toolbar')
    @include('layouts.partials._toolbar', [
        'title' => 'Warehouses',
        'breadcrumbs' => ['Admin', 'Masterdata', 'Warehouses'],
    ])
@endpush
            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" id="warehouse_search_input" class="form-control form-control-solid w-250px ps-15"
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#table-on-page').DataTable({
                ...
                'columnDefs': [{
                    orderable: false,
                    targets: 4 // Changed from 5 to 4 because one column (email/jabatan) is removed
                }, ]
            });

            $('#warehouse_search_input').on('keyup', function() {
            ...
            if (canDelete) {
                $('#table-on-page').on('submit', '.form-delete', function(e) {
                    ...
                    var form = $(this);
                    var n = form.find('button[data-warehouse-name]').data('warehouse-name');
