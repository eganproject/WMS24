<head><base href="">
		<title>COK - Warehouse Management System</title>
		...
		<link rel="shortcut icon" href="{{ asset('metronic/assets/media/logos/logo-demo2.png') }}" />
		<link rel="icon" type="image/png" href="{{ asset('metronic/assets/media/logos/logo-demo2.png') }}" />
		<!--begin::Fonts-->
