...
Route::middleware(['auth', 'verified', 'menu.permission'])->prefix('admin')->as('admin.')->group(function () {
    ...
    Route::prefix('inventory')->as('inventory.')->group(function () {
        ...
        Route::get('/damaged-goods/export', [DamagedGoodsController::class, 'export'])->name('damaged-goods.export');
        ...
        Route::delete('/resi-import/{id}', [ResiImportController::class, 'destroy'])->name('resi-import.destroy');
    ...
    Route::prefix('reports')->as('reports.')->group(function () {
        ...
        Route::get('/kpi/assignments/data', [KpiController::class, 'assignmentsData'])->name('kpi.assignments.data');
        Route::post('/kpi/assignments', [KpiController::class, 'storeAssignment'])->name('kpi.assignments.store');
        Route::put('/kpi/assignments/{assignment}', [KpiController::class, 'updateAssignment'])->name('kpi.assignments.update');
        Route::delete('/kpi/assignments/{assignment}', [KpiController::class, 'destroyAssignment'])->name('kpi.assignments.destroy');
        Route::get('/kpi/snapshots/data', [KpiController::class, 'snapshotsData'])->name('kpi.snapshots.data');
